...
static void MX_SPI1_Init(void)
{
  ...
  handle_SPI_1.Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_64; // SYSCLK/64 = 2.5MBits/s @160MHz
...
{
  if (hspi == &handle_SPI_1) // SPI1 : toggle RED led
  {
    HAL_GPIO_TogglePin(GPIOH, GPIO_PIN_6);
  }
  if (hspi == &handle_SPI_3) // SPI3 : toggle GREEN
  {
