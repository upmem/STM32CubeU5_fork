...
#define NS_DATA_IMAGE_DATA1_SIZE            (FLASH_NS_DATA_PARTITION_SIZE)

#define FLASH_NS_DATA_START          (NS_ROM_ALIAS((NS_DATA_IMAGE_PRIMARY_PARTITION_OFFSET + NS_DATA_IMAGE_DATA1_OFFSET)))
#endif /* (MCUBOOT_NS_DATA_IMAGE_NUMBER == 1) */
